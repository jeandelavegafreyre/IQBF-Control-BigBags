...
function SummaryMetric({ label, value }: SummaryMetricProps) { return <div className="operations-metric"><span>{label}</span><strong>{value}</strong></div> }
